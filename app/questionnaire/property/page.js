  ...
  return (
    <div className="max-w-xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* Down Payment Option */}
        <div className="flex flex-col space-y-4">
          <p className="text-2xl">How much was your downpayment?</p>
          <div className="grid grid-cols-2 gap-4">
            {downpaymentOptions.map((option) => (
              <label key={option} className="block">
                <input
                  type="radio"
                  value={option}
                  {...register("downpaymentOption", {
                    required: "Select down payment option",
                  })}
                  className="sr-only peer"
                />
                <div className="cursor-pointer rounded-md border bg-white border-gray-300 p-4 peer-checked:border-blue-600 peer-checked:ring ring-blue-600 peer-checked:bg-blue-100 hover:bg-blue-100 text-center">
          ...
          {errors.downpaymentOption && (
            <p className="text-red-600 mt-1">
              {errors.downpaymentOption.message}
            </p>
          )}
        </div>
