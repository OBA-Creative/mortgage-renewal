            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full h-12 px-3 py-2 placeholder-gray-400 border border-gray-300 rounded-sm shadow-sm appearance-none focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:ring-1"
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full h-12 px-3 py-2 placeholder-gray-400 border border-gray-300 rounded-sm shadow-sm appearance-none focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 "
