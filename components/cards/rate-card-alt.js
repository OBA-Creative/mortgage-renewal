      ...
      <div className="flex flex-col items-center grow">
        <div className="relative inline-flex items-center justify-center">
          <select
            ...
            className="w-full py-1 pl-2 pr-5 text-center bg-transparent border-none appearance-none cursor-pointer focus:outline-none"
          >
        ...
        <p className="text-6xl font-bold ">{displayPayment}</p>
      </div>
